...
class InstitutionStaffController extends Controller
{
    ...
    public function update(InstitutionStaffEditRequest $request): \Inertia\Response
    {
        ...
        $institution = Institution::where('guid', $request->institution_guid)->with(['staff.user.roles'])->first();
    ...
    public function updateRole(Request $request): \Inertia\Response
    {
        ...
        $institution = Institution::where('guid', $request->input('institution_guid'))->with(['staff.user.roles'])->first();
        $countries = app(PdexService::class)->countries();
